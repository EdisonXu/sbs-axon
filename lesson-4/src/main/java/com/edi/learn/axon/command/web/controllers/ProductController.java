...
public class ProductController {
    ...
    public void create(@PathVariable(value = "id") String id,
                    ...
                    @RequestParam(value = "stock",required = true) long stock,
                    HttpServletResponse response) {

        LOGGER.debug("Adding Product [{}] '{}'x{}", id, name,stock);

        try {
            CreateProductCommand command = new CreateProductCommand(id,name,stock);
